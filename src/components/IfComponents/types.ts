 ...
 */
export type ComponentWithConditionPropsWithFunctionChildren<P = NonNullObject> =
  P &
 ...
 */
export type ComponentWithConditionPropsAsyncSupport =
  ComponentWithConditionProps<AsyncSupportProps>;

export type FCWithImplicitChildren<P = NonNullObject> =
  FunctionComponentWithImplicitChildren<P>;

export interface FunctionComponentWithImplicitChildren<P = NonNullObject> {
  (props: CustomPropsWithChildren<P>, context?: any): ReactElement<
    any,
    any
  > | null;
